...
By default the generation of views is disabled. To turn it on you have to set the following system property or compiler argument `micronaut.openapi.views.spec`.
...
tasks.withType(JavaCompile){
    options.fork = true
    options.compilerArgs.add('-Amicronaut.openapi.views.spec=rapidoc.enabled=true,swagger-ui.enabled=true,swagger-ui.theme=flattop')
